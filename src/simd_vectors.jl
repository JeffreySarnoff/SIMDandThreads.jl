...
simdvec(x::NTuple{N1,T}, y::NTuple{N2,T}, z::NTuple{N3,T}, w::NTuple{N4,T}) where {N1,N2,N3,N4,T} =
    SIMD.Vec{N1+N2+N3+N4,T}((x..., y..., z..., w...))
simdvec(x::Vec{N1,T}, y::Vec{N2,T}, z::Vec{N3,T}, w::Vec{N4,T}) where {N1,N2,N3,N4,T} = 
